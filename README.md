...
| `@leo-alvarenga/pi-zen-frame`      | `packages/pi-zen-frame`      | 0.17.0 | Polished frame/header look for the TUI editor                             |
...
| `@leo-alvarenga/pi-notify`         | `packages/pi-notify`         | 0.2.0  | Desktop notification + sound when a prompt settles (D-Bus, Linux, opt-in) |
