...
| ---------------------------------- | ----------------------------- | ------ | --------------------------------------------------------------- |
| `@leo-alvarenga/pi-agent-manager`  | `packages/pi-agent-manager`   | 0.18.2 | Agent-mode switching with OpenCode-style permission guards      |
...
| `@leo-alvarenga/pi-mini-subagents` | `packages/pi-mini-subagents`  | 0.1.0  | Transient subagents: `mini_subagent` tool + live TUI panel      |
| `@leo-alvarenga/pi-todo-list`      | `packages/pi-todo-list`       | 0.4.1  | Session-aware todo list overlay + live TUI panel                |
